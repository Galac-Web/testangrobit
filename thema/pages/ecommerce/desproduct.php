                                ...
                                <div class="sticky-md-top product-sticky">
                                    <div id="carouselExampleCaptions" class="carousel slide ecomm-prod-slider" data-bs-ride="carousel">
                                            ...
                                            <div class="card-body position-absolute bottom-0 end-0">
                                                <ul class="list-inline ms-auto mb-0 prod-likes">
                                                    <li class="list-inline-item m-0">
                                                        <a href="ecom_product-details.html#" class="avtar avtar-xs text-white text-hover-primary">
                                        ...
                                        <ol class="list-inline carousel-indicators position-relative product-carousel-indicators my-sm-3 mx-0">
                                            <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" class="list-inline-item w-25 h-auto">
                                                <img src="../assets/images/application/img-prod-1.jpg" class="d-block wid-50 rounded" alt="Product images">
                                            </li>
                                            <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="1" class="list-inline-item w-25 h-auto active" aria-current="true">
                    ...
                    <div class="card-header pb-0">
                        <ul class="nav nav-tabs profile-tabs mb-0" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="ecomtab-tab-1" data-bs-toggle="tab" href="ecom_product-details.html#ecomtab-1" role="tab" aria-controls="ecomtab-1" aria-selected="true">Features
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="ecomtab-tab-2" data-bs-toggle="tab" href="ecom_product-details.html#ecomtab-2" role="tab" aria-controls="ecomtab-2" aria-selected="false" tabindex="-1">Specifications
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="ecomtab-tab-3" data-bs-toggle="tab" href="ecom_product-details.html#ecomtab-3" role="tab" aria-controls="ecomtab-3" aria-selected="false" tabindex="-1">Overview
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="ecomtab-tab-4" data-bs-toggle="tab" href="ecom_product-details.html#ecomtab-4" role="tab" aria-controls="ecomtab-4" aria-selected="false" tabindex="-1">Reviews<span class="badge bg-light-primary rounded-pill px-2 ms-2">275</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="mb-2 text-muted mt-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                                                    industry's standard dummy text ever since the 1500.</p>
                                                <a href="ecom_product-details.html#" class="link-primary mb-1">https://phoenixcoded.net/</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-xxl-3 col-xl-4">
                                <div class="card product-card mb-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <a href="ecom_product-details.html#" class="avtar avtar-s btn-link-secondary btn-prod-card">
